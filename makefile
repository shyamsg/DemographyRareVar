...
rareDemo:	code/newickTreeNode.o code/ARG.o code/siteStat.o code/argHelper.o code/argStatMiner.o code/main.o
	${CPP}	${LDFLAGS} -o rareDemo code/main.o code/ARG.o code/newickTreeNode.o code/argHelper.o code/siteStat.o code/argStatMiner.o

clean:
	rm	-f code/*.o rareDemo
